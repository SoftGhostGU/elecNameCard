...
const PermissionModule = forwardRef((props, ref) => {
    ...
    const submit = async () => {
        try {
            ...
            let params = {
                ...values, menuType: Number(radioValue),
                isRoute: route ? 1 : 0, hidden: hidden ? 1 : 0, keepAlive: keepAlive ? 1 : 0, alwaysShow: alwaysShow ? 1 : 0, internalOrExternal: internalOrExternal ? 1 : 0, parentId: radioValue == 1 ? value : null
            }
        ...
        <>
            <Drawer title={title} placement="right" onClose={() => {
                ...
                >
                    ...
                    >
                        <InputNumber min='1' max="999999" placeholder="请输入菜单排序" style={{ width: "100%" }} readOnly={menulocal.langth!=0?menulocal[0].id == id:false}/>
                    </Form.Item>
                    <Form.Item
                        label="是否路由菜单"
                        name="route"
